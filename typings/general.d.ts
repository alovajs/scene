 ...
 */
interface RetriableRetryEvent<S, E, R, T, RC, RE, RH, ARG extends any[]>
 ...
 */
interface RetriableFailEvent<S, E, R, T, RC, RE, RH, ARG extends any[]>
  extends AlovaErrorEvent<S, E, R, T, RC, RE, RH, ARG> {
  /**
   * 失败时的重试次数
   */
  retryTimes: number;
