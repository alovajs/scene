...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('alova'), require('svelte/store')) :
	typeof define === 'function' && define.amd ? define(['exports', 'alova', 'svelte/store'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AlovaSceneHook = {}, global.alova, global["svelte/store"]));
})(this, (function (exports, alova, store) { 'use strict';
	 ...
	 * @returns {Writable}
	 */
	const $ = data => store.writable(data);
	 ...
	 */
	const $$ = (getter, depList) => store.derived(depList, getter);
